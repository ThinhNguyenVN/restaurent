...
<!--            <p class="border-1"></p><a href="#" class="link-1">read more</a>-->
       	...
       	<div class="col-1"><h2 class="h2-line">View Pending Deliveries  </h2>
              <div class="box-1"> 
            	  <div class="extra-wrap">
                        <table border="2" >
                                <tr style="color:#459a6f "><th>Selected Items  </th> <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                               ...
                               while (rs.next())   { %>
                                ...
                                <form action="carupdate.jsp?q=6"method="post" >
                               <tr align="center"> 
   ...
   <%    }   %>
           ...
           <%} 
           	...
           	<div class="col-1">   <h5 class="p1"> <a href="viewdeliverie.jsp?val=1">View Pending DeliveriesDetails </a>   <br>       
                                  <a href="viewdeliverie.jsp?val=2">View Completed Deliveries Details</a> </h5>    
              <div class="box-1"> 
            	  <div class="extra-wrap">
