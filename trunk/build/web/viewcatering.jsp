...
<!--            <p class="border-1"></p><a href="#" class="link-1">read more</a>-->
    ...
    <%     }   %>
                      ...
                      <%} if(v.equals("2"))
                                          { %>
           	<div class="col-1"><h2 class="h2-line">View Completed  Catering  </h2>
              <div class="box-1"> 
            	  <div class="extra-wrap">
                        <table border="2" >
                                <tr style="color:#459a6f "><th>Selectd Item </th> <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
    ...
    <%     }   %>
           ...
           <%} 
           	...
           	<div class="col-1">   <h5 class="p1"> <a href="viewcatering.jsp?val=1">View Pending Catering Details </a>   <br>       
                                  <a href="viewcatering.jsp?val=2">View Completed Catering Details</a> </h5>    
              <div class="box-1"> 
            	  <div class="extra-wrap">
