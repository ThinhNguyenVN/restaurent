        ...
        <nav>  
            <ul class="menu">
                        ...
                        <li><a  href="viewcarryout.jsp">View Carry outs</a> </li>  
                            ...
                            <li><a class="current" href="viewcaterings.jsp">View Catering</a> </li> 
...
<!--            <p class="border-1"></p><a href="#" class="link-1">read more</a>-->
       ...
       <div class="block-2 pad-1">
           ...
           %>
       	<div class="col-1"><h2 class="h2-line">View Pending Catering  </h2>
              <div class="box-1"> 
            	  <div class="extra-wrap">
                      <table border="2" >
                                <tr style="color:#459a6f "><th>Selected Item </th> <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                 <th>Time  </th>        <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>  
                                 <th> Date </th>    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td> 
                                 <th> Address </th>    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td> 
                                 <th>No. of Peoples    </th>     <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                 <th>Order Name </th>    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td> 
                                 <th>Action </th> 
                                </tr>
                                <%    ResultSet rs= st.executeQuery("select * from catering where status='pending'"); 
                                //String imgnme =email.replaceAll("\\.", "")+"."+p1a[1];
                               while (rs.next())   { %>
 
                              <form action="carupdate.jsp?q=7"method="post" >
                               <tr align="center"> 
   ...
   <%    }   %>
                      ...
                      <%} if(v.equals("2"))
                                          { %>
           	<div class="col-1"><h2 class="h2-line">View Completed Caterings   </h2>
              <div class="box-1"> 
            	  <div class="extra-wrap">
                       <table border="2" >
                       ...
                       <tr style="color:#459a6f "><th>Selected Item </th> <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                ...
                                <%    ResultSet rs= st.executeQuery("select * from catering where status='complete'"); 
                                //String imgnme =email.replaceAll("\\.", "")+"."+p1a[1];
                               while (rs.next())   { %>
           ...
           <%} 
           	...
           	<div class="col-1">   <h5 class="p1"> <a href="viewcaterings.jsp?val=1">View Pending Catering Details </a>   <br>       
                                  <a href="viewcaterings.jsp?val=2">View Completed Catering Details</a> </h5>    
              <div class="box-1"> 
            	  <div class="extra-wrap">
