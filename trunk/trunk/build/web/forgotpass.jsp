...
<!--        	<h3 class="h3-line">Contact info</h3>
        ...
        <div class="col-4 left-2">
        	<h3 class="h3-line">Forgot password </h3>
                <form id="form"action="for1.jsp?val=1" method="post" name="f"  onsubmit="return fun()" >
              <fieldset>
                  <%
                        String val =request.getParameter("val"); 
                            if(val!=null) 
                                          {%>    <label style="color:purple">  Invalid details so please enter again   </label> <%  }  %> 
               <label><strong>UserName:</strong><input name="uname" type="text" ><strong class="clear"></strong></label>
                
               <label><strong>Select Type :</strong><select name="gender" >
