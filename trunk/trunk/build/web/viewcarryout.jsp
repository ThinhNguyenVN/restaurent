...
<!--            <p class="border-1"></p><a href="#" class="link-1">read more</a>-->
              ...
              <div class="box-1"> 
            	  <div class="extra-wrap">
                     <table border="2" >
                               ...
                               <form action="carupdate.jsp?q=9"method="post" >
                               <tr align="center"> 
   ...
   <%    }   %>
           ...
           <%} 
           	...
           	<div class="col-1">   <h5 class="p1"> <a href="viewcarryout.jsp?val=1">View Pending Carryout Details </a>   <br>             <a href="viewcarryout.jsp?val=2">View Completed Carryout Details</a> </h5>    
              <div class="box-1"> 
            	  <div class="extra-wrap">
